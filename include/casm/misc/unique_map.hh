...
///
/// UniqueType should be Unique or const Unique, and MapIteratorType should be
/// std::map<int, std::unique_ptr<UniqueType> > with const-ness matching the
/// UniqueType.
///
...
///   - \code MapType::mapped_type(ValueType) \endcode must be a valid
///   constructor.
/// - TransformFunction and ConstTransformFunction, unary function types, to
/// convert
///   *MapType::iterator to ValueType& and *MapType::const_iterator to const
///   ValueType*
///
